...
public class PersonControllerTest {
    ...
    @Test
    public void deletePassingUnknownPersonObjectReturns404() throws Exception {
        when(personService.areFirstNameAndLastnamePresent("Fake", "Faker")).thenReturn(false);
        mockMvc.perform(delete("/person/Fake/Faker")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.message", is("No person found with firstname Fake and lastname Faker")));
    }
    ...
    public void deleteValidPersonReturns200() throws Exception {
        when(personService.areFirstNameAndLastnamePresent("Jo-Jo", "Palmas")).thenReturn(true);
        mockMvc.perform(delete("/person/Jo-Jo/Palmas")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    public void nullVariablesReturns404() throws Exception {
